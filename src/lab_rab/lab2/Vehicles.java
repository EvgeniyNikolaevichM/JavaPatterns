...
public class Vehicles {
    ...
    private static TransportFactory factory = new AutoFactory(); //Для фабрики: объявляем перенную. Настройки:

    public static void setTransportFactory(TransportFactory transportFactory) {
        factory = transportFactory;
    }//чтобы установить, то какой объкт создаем(либо авто либо мото-фактори)

    public static IVehicle createInstance(String brand, int modelsSize) {//Создаем объект используя методы в мото и кар фактори
