...
//добавляет дополнительные обязанности во время выполнения программы не меняя логику кода
//методы как вызывали, так и вызываем, но еще синхронизируем потоки (чтобы был только один поток 1 вып работу потом другой)
//В вениклся добавлен метод внизу сериалайз декоратор
